                              ...
                              TestedKeyTypes)
{
  ...
  BOOST_CHECK_EQUAL(map[321], "Not it");
}
                              ...
                              TestedKeyTypes)
{
  ...
  thenConstructedObjectsCountWas<K>(4);
  thenCopiedObjectsCountWas<K>(2);
                              ...
                              TestedKeyTypes)
{
  ...
  thenConstructedObjectsCountWas<K>(2);
